...
A [morphism](./category.md) $f\colon X \to Y$ is called a **monomorphism**, a
**mono**, or **monic** if for every [object](./category.md) $Z$,
...
$\mathrm{Hom}(Z, X) \rightarrowtail \mathrm{Hom}(Z, Y)$.[^1]
