...
**Lost purposes** describe a phenomenon where individuals or groups set a goal but engage only in the least challenging or minimal necessary activities, which do not *effectively* contribute towards achieving the goal (the activity **loses its purpose**). This behavior turns the original goal into a nominal target—essentially a facade—where the primary focus shifts from genuine achievement to the appearance of progress.
...
> I watched this behaviour for a while before commenting.  Eventually I asked her about it and she conceded she was doing tasks that seem easier than the important things because they feel like progress, say by doing four small 15 minute tasks you got four things done right?  Whereas if you work on an important task for an hour you only got one thing done.[^1]
